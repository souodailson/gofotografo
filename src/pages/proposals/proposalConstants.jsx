...
export const textBlockOptions = [
  {
    ...
    styles: { ...defaultStyles, fontSize: '48px', fontWeight: 'bold' }
  },
  {
    type: 'text',
    ...
    styles: { ...defaultStyles, fontSize: '32px', fontWeight: 'bold' }
  },
  {
    type: 'text',
    ...
    styles: { ...defaultStyles, fontSize: '16px' }
  },
];
...
export const availableBlocks = [
  {
    ...
    styles: { ...defaultStyles, paddingTop: '0px', paddingBottom: '0px', paddingLeft: '0px', paddingRight: '0px', width: '100%', borderRadius: '0px' },
  },
   {
    type: 'pdf',
    label: 'PDF',
    ...
    content: { src: '' },
    styles: { ...defaultStyles, paddingTop: '0px', paddingBottom: '0px', paddingLeft: '0px', paddingRight: '0px', width: '100%', height: '600px' }
  },
   {
    type: 'packages',
    label: 'Pacotes',
    ...
    styles: { ...defaultStyles, paddingTop: '40px', paddingBottom: '40px', paddingLeft: '20px', paddingRight: '20px' },
  },
  {
    type: 'video',
    label: 'Vídeo',
    ...
    styles: { ...defaultStyles, paddingTop: '0px', paddingBottom: '0px', paddingLeft: '0px', paddingRight: '0px' },
  },
  {
    type: 'testimonial',
    label: 'Depoimento',
  ...
  },
  {
    ...
    styles: { ...defaultStyles, paddingTop: '50px', paddingBottom: '50px', paddingLeft: '20px', paddingRight: '20px', color: '#333333', textAlign: 'center' },
  },
  {
    type: 'social',
    label: 'Redes Sociais',
    ...
    styles: { ...defaultStyles, paddingTop: '20px', paddingBottom: '20px', iconColor: '#333333', alignment: 'center' },
  },
  {
    type: 'button',
    label: 'Botão',
    ...
    styles: { ...defaultStyles, paddingTop: '0px', paddingBottom: '0px', paddingLeft: '0px', paddingRight: '0px', textAlign: 'center', color: '#3B82F6', borderWidth: '0px' },
  },
  {
    type: 'divider',
    label: 'Divisor',
    icon: <Divide size={18} />,
    content: {},
    styles: { ...defaultStyles, paddingTop: '10px', paddingBottom: '10px', paddingLeft: '20px', paddingRight: '20px' },
  },
  {
    type: 'spacer',
    label: 'Espaçador',
...
export const elementBlocks = [
  {
    ...
    icon: <Box size={18} />,
    content: {},
    styles: { ...defaultStyles, borderRadius: '8px', borderWidth: '1px', borderStyle: 'solid', borderColor: '#e0e0e0' },
  },
  {
    type: 'shape',
    label: 'Retângulo',
  ...
  },
  {
    ...
    styles: { ...defaultStyles, borderColor: '#000000', borderWidth: '2px' },
  },
  {
    type: 'icon',
    label: 'Ícone',
    ...
    styles: { ...defaultStyles, color: '#000000' },
  },
];
